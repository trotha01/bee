...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var delta = A2($Signal.map,function (t) {    return t / 20;},A2($Signal.sampleOn,$Time.every($Time.millisecond * 15),$AnimationFrame.frame));
   ...
   var updateSprite = function (model) {    return _U.update(model,{sprite: A2($Basics._op["%"],model.sprite + 1,2)});};
   var Away = {ctor: "Away"};
   var Toward = {ctor: "Toward"};
   var Right = {ctor: "Right"};
   var Left = {ctor: "Left"};
   var setDirection = F2(function (_p22,model) {
      var _p23 = _p22;
      var _p25 = _p23.y;
      var _p24 = _p23.x;
      return _U.update(model,
      {orientation: _U.cmp(_p25,0) < 0 ? Toward : _U.cmp(_p25,0) > 0 ? Away : model.orientation
      ,dir: _U.cmp(_p24,0) > 0 ? Right : _U.cmp(_p24,0) < 0 ? Left : model.dir});
   });
