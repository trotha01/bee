...
Elm.Sprite.make = function (_elm) {
   ...
   if (_elm.Sprite.values) return _elm.Sprite.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var imgFromSpriteSheet = F2(function (spriteSheet,_p0) {
      var _p1 = _p0;
      return A2($Html.img,
      _U.list([$Html$Attributes.src("empty.png")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "32px"}
                                              ,{ctor: "_Tuple2",_0: "height",_1: "32px"}
                                              ,{ctor: "_Tuple2",_0: "background-image",_1: A2($Basics._op["++"],"url(",A2($Basics._op["++"],spriteSheet,")"))}
                                              ,{ctor: "_Tuple2"
                                               ...
                                               A2($Basics._op["++"],"px -",A2($Basics._op["++"],$Basics.toString(_p1._1),"px"))))}]))]),
      _U.list([]));
   });
   var beeFromSpriteSheet = imgFromSpriteSheet("bee.png");
   var northWestBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 0});
   var northWestBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 32});
   var northEastBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 0});
   var northEastBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 0});
   var southWestBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 32});
   var southWestBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 32});
   var southEastBee1 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 64});
   var southEastBee2 = beeFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 64});
   var tileFromSpriteSheet = imgFromSpriteSheet("terrain.png");
   var grass = tileFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 0});
   var vertPath = tileFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 0});
   var crossPath = tileFromSpriteSheet({ctor: "_Tuple2",_0: 64,_1: 0});
   var horzPath = tileFromSpriteSheet({ctor: "_Tuple2",_0: 0,_1: 32});
   var tPath = tileFromSpriteSheet({ctor: "_Tuple2",_0: 32,_1: 32});
   return _elm.Sprite.values = {_op: _op
                               ,imgFromSpriteSheet: imgFromSpriteSheet
                               ,beeFromSpriteSheet: beeFromSpriteSheet
                               ,northWestBee1: northWestBee1
                               ,northWestBee2: northWestBee2
                               ,northEastBee1: northEastBee1
                               ,northEastBee2: northEastBee2
                               ,southWestBee1: southWestBee1
                               ,southWestBee2: southWestBee2
                               ,southEastBee1: southEastBee1
                               ,southEastBee2: southEastBee2
                               ,tileFromSpriteSheet: tileFromSpriteSheet
                               ,grass: grass
                               ,vertPath: vertPath
                               ,crossPath: crossPath
                               ,horzPath: horzPath
...
Elm.Map.make = function (_elm) {
   "use strict";
   _elm.Map = _elm.Map || {};
   if (_elm.Map.values) return _elm.Map.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p3 = action;
      if (_p3.ctor === "VerticalScroll") {
            return _U.update(model,{top: A3($Basics.clamp,0 - overflowHeight,0,model.top + _p3._0)});
         } else {
            return _U.update(model,{left: A3($Basics.clamp,0 - overflowWidth,0,model.left - _p3._0)});
         }
   });
   var fullMap = function (model) {
      ...
      _U.list([column(_U.list([row(_U.list([$Sprite.grass
                                           ,$Sprite.grass
                                           ,$Sprite.grass
                                           ,$Sprite.grass
                                           ,$Sprite.grass
...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var delta = A2($Signal.map,function (t) {    return t / 20;},$Time.fps(25));
   var input = A2($Signal.sampleOn,
   delta,
   A4($Signal.map3,F3(function (v0,v1,v2) {    return {ctor: "_Tuple3",_0: v0,_1: v1,_2: v2};}),delta,$Keyboard.arrows,$Keyboard.shift));
   var viewBee = function (_p0) {
      var _p1 = _p0;
      var beeImage = function () {
         var _p2 = {ctor: "_Tuple3",_0: _p1.dir,_1: _p1.orientation,_2: _p1.sprite};
         _v1_8: do {
            if (_p2._0.ctor === "Left") {
                  if (_p2._1.ctor === "Toward") {
                        switch (_p2._2)
                        {case 0: return $Sprite.southWestBee1;
                           case 1: return $Sprite.southWestBee2;
                           default: break _v1_8;}
                     } else {
                        switch (_p2._2)
                        {case 0: return $Sprite.northWestBee1;
                           case 1: return $Sprite.northWestBee2;
                           default: break _v1_8;}
                     }
               } else {
                  if (_p2._1.ctor === "Toward") {
                        switch (_p2._2)
                        {case 0: return $Sprite.southEastBee1;
                           case 1: return $Sprite.southEastBee2;
                           default: break _v1_8;}
                     } else {
                        switch (_p2._2)
                        {case 0: return $Sprite.northEastBee1;
                           case 1: return $Sprite.northEastBee2;
                           default: break _v1_8;}
                     }
               }
         } while (false);
         return $Sprite.southWestBee1;
      }();
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "32px"}
                                              ,{ctor: "_Tuple2",_0: "height",_1: "32px"}
                                              ,{ctor: "_Tuple2",_0: "position",_1: "relative"}
                                              ,{ctor: "_Tuple2",_0: "top",_1: A2($Basics._op["++"],"-",A2($Basics._op["++"],$Basics.toString(_p1.y),"px"))}
                                              ,{ctor: "_Tuple2",_0: "left",_1: A2($Basics._op["++"],$Basics.toString(_p1.x),"px")}]))]),
      _U.list([beeImage]));
   };
   var view = F2(function (_p4,_p3) {
      ...
      _U.list([inner]));
      var outer = A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "table"}
   ...
   var newVelocity = F3(function (isRunning,_p18,model) {
      var _p19 = _p18;
      var _p21 = _p19.y;
      var _p20 = _p19.x;
      var scale = isRunning ? 4 : 2;
      var newVel = function (n) {    return _U.eq(_p20,0) || _U.eq(_p21,0) ? scale * $Basics.toFloat(n) : scale * $Basics.toFloat(n) / $Basics.sqrt(2);};
      return _U.update(model,{vx: newVel(_p20),vy: newVel(_p21)});
   });
   var updateSprite = function (_p22) {    var _p23 = _p22;var _p24 = _p23;return _U.update(_p24,{sprite: A2($Basics._op["%"],_p24.sprite + 1,2)});};
   var Away = {ctor: "Away"};
   var Toward = {ctor: "Toward"};
   var Right = {ctor: "Right"};
   var Left = {ctor: "Left"};
   var setDirection = F2(function (_p25,model) {
      var _p26 = _p25;
      var _p28 = _p26.y;
      var _p27 = _p26.x;
      return _U.update(model,
      {orientation: _U.cmp(_p28,0) < 0 ? Toward : _U.cmp(_p28,0) > 0 ? Away : model.orientation
      ,dir: _U.cmp(_p27,0) > 0 ? Right : _U.cmp(_p27,0) < 0 ? Left : model.dir});
   });
   var update = F2(function (_p29,model) {
      var _p30 = _p29;
      var _p32 = _p30._0;
      var _p31 = _p30._1;
      return updateSprite(A2(updateMap,_p32,A2(updatePosition,_p32,A2(setDirection,_p31,A3(newVelocity,_p30._2,_p31,model)))));
   });
   var Model = F8(function (a,b,c,d,e,f,g,h) {    return {x: a,y: b,vx: c,vy: d,dir: e,orientation: f,sprite: g,map: h};});
   var initialModel = A8(Model,$Map.halfWidth,$Map.halfHeight,0,0,Left,Toward,0,$Map.init);
