...
var _user$project$Tiles$imgFromSpriteSheet = F2(
	function (spriteSheet, _p0) {
		var _p1 = _p0;
		return A2(
			_elm_lang$html$Html$img,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$src('empty.png'),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_1: A2(
								...
								'url(',
								A2(_elm_lang$core$Basics_ops['++'], spriteSheet, ')'))
						},
							{
							ctor: '_Tuple2',
...
var _user$project$Tiles$tileFromSpriteSheet = _user$project$Tiles$imgFromSpriteSheet('terrain.png');
var _user$project$Tiles$grass = _user$project$Tiles$tileFromSpriteSheet(
	{ctor: '_Tuple2', _0: 0, _1: 0});
var _user$project$Tiles$vertPath = _user$project$Tiles$tileFromSpriteSheet(
	{ctor: '_Tuple2', _0: 32, _1: 0});
var _user$project$Tiles$crossPath = _user$project$Tiles$tileFromSpriteSheet(
	{ctor: '_Tuple2', _0: 64, _1: 0});
var _user$project$Tiles$horzPath = _user$project$Tiles$tileFromSpriteSheet(
	{ctor: '_Tuple2', _0: 0, _1: 32});
var _user$project$Tiles$tPath = _user$project$Tiles$tileFromSpriteSheet(
	{ctor: '_Tuple2', _0: 32, _1: 32});

var _user$project$Map$column = function (divs) {
	return A2(
...
var _user$project$Map$row = function (divs) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Map$_p0 = {ctor: '_Tuple2', _0: 224, _1: 224};
var _user$project$Map$width = _user$project$Map$_p0._0;
var _user$project$Map$height = _user$project$Map$_p0._1;
var _user$project$Map$_p1 = {ctor: '_Tuple2', _0: _user$project$Map$width / 2, _1: _user$project$Map$height / 2};
var _user$project$Map$halfWidth = _user$project$Map$_p1._0;
var _user$project$Map$halfHeight = _user$project$Map$_p1._1;
var _user$project$Map$_p2 = {ctor: '_Tuple2', _0: 288, _1: 288};
var _user$project$Map$fullMapWidth = _user$project$Map$_p2._0;
var _user$project$Map$fullMapHeight = _user$project$Map$_p2._1;
var _user$project$Map$_p3 = {ctor: '_Tuple2', _0: _user$project$Map$fullMapWidth - _user$project$Map$width, _1: _user$project$Map$fullMapHeight - _user$project$Map$height};
var _user$project$Map$overflowWidth = _user$project$Map$_p3._0;
var _user$project$Map$overflowHeight = _user$project$Map$_p3._1;
var _user$project$Map$init = {
	top: _elm_lang$core$Basics$round(0 - (_user$project$Map$overflowHeight / 2)),
	left: _elm_lang$core$Basics$round(0 - (_user$project$Map$overflowWidth / 2))
};
var _user$project$Map$update = F2(
	function (action, model) {
		var _p4 = action;
		if (_p4.ctor === 'VerticalScroll') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					top: A3(_elm_lang$core$Basics$clamp, 0 - _user$project$Map$overflowHeight, 0, model.top + _p4._0)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					left: A3(_elm_lang$core$Basics$clamp, 0 - _user$project$Map$overflowWidth, 0, model.left - _p4._0)
				});
		}
	});
var _user$project$Map$fullMap = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_1: A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_user$project$Map$fullMapWidth),
							'px')
					},
						{
						ctor: '_Tuple2',
						...
						_1: A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_user$project$Map$fullMapHeight),
							'px')
					},
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Map$column(
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Map$row(
						_elm_lang$core$Native_List.fromArray(
							[_user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$vertPath, _user$project$Tiles$grass, _user$project$Tiles$grass])),
						_user$project$Map$row(
						_elm_lang$core$Native_List.fromArray(
							[_user$project$Tiles$horzPath, _user$project$Tiles$horzPath, _user$project$Tiles$horzPath, _user$project$Tiles$horzPath, _user$project$Tiles$horzPath, _user$project$Tiles$horzPath, _user$project$Tiles$crossPath, _user$project$Tiles$horzPath, _user$project$Tiles$horzPath])),
						_user$project$Map$row(
						_elm_lang$core$Native_List.fromArray(
							[_user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$grass, _user$project$Tiles$vertPath, _user$project$Tiles$grass, _user$project$Tiles$grass])),
						_user$project$Map$row(
...
var _user$project$Map$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_1: A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_user$project$Map$width),
							'px')
					},
						{
						ctor: '_Tuple2',
						...
						_1: A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_user$project$Map$height),
							'px')
					},
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Map$fullMap(model)
			]));
};
var _user$project$Map$Model = F2(
	function (a, b) {
		return {top: a, left: b};
	});
var _user$project$Map$HorizontalScroll = function (a) {
	return {ctor: 'HorizontalScroll', _0: a};
};
var _user$project$Map$VerticalScroll = function (a) {
	return {ctor: 'VerticalScroll', _0: a};
};

var _user$project$Sprite$imgFromSpriteSheet = F2(
	function (spriteSheet, _p0) {
		var _p1 = _p0;
		return A2(
			_elm_lang$html$Html$img,
...
var _user$project$Sprite$beeFromSpriteSheet = _user$project$Sprite$imgFromSpriteSheet('bee.png');
var _user$project$Sprite$northWestBee1 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 64, _1: 0});
var _user$project$Sprite$northWestBee2 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 0, _1: 32});
var _user$project$Sprite$northEastBee1 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 0, _1: 0});
var _user$project$Sprite$northEastBee2 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 32, _1: 0});
var _user$project$Sprite$southWestBee1 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 32, _1: 32});
var _user$project$Sprite$southWestBee2 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 64, _1: 32});
var _user$project$Sprite$southEastBee1 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 0, _1: 64});
var _user$project$Sprite$southEastBee2 = _user$project$Sprite$beeFromSpriteSheet(
	{ctor: '_Tuple2', _0: 32, _1: 64});
var _user$project$Sprite$view = function (_p2) {
	var _p3 = _p2;
	var beeImage = function () {
		var _p4 = {ctor: '_Tuple3', _0: _p3.dir, _1: _p3.orientation, _2: _p3.frame};
		_v2_8:
		do {
			if (_p4._0.ctor === 'Left') {
				if (_p4._1.ctor === 'Toward') {
					switch (_p4._2) {
						case 0:
							return _user$project$Sprite$southWestBee1;
						case 1:
							return _user$project$Sprite$southWestBee2;
						default:
							break _v2_8;
					}
				} else {
					switch (_p4._2) {
						case 0:
							return _user$project$Sprite$northWestBee1;
						case 1:
							return _user$project$Sprite$northWestBee2;
						default:
							break _v2_8;
					}
				}
				...
				if (_p4._1.ctor === 'Toward') {
					switch (_p4._2) {
						case 0:
							return _user$project$Sprite$southEastBee1;
						case 1:
							return _user$project$Sprite$southEastBee2;
						default:
							break _v2_8;
					}
				} else {
					switch (_p4._2) {
						case 0:
							return _user$project$Sprite$northEastBee1;
						case 1:
							return _user$project$Sprite$northEastBee2;
						default:
							break _v2_8;
					}
				}
...
var _user$project$Sprite$updateFrame = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			frame: A2(_elm_lang$core$Basics_ops['%'], model.frame + 1, 2)
		});
};
var _user$project$Sprite$updatePosition = F2(
	function (dt, _p5) {
		var _p6 = _p5;
		return _elm_lang$core$Native_Utils.update(
			_p6,
			{
				x: A3(_elm_lang$core$Basics$clamp, 0, _user$project$Map$width - 32, _p6.x + (dt * _p6.vx)),
				y: A3(_elm_lang$core$Basics$clamp, 32, _user$project$Map$height, _p6.y + (dt * _p6.vy))
			});
	});
var _user$project$Sprite$newVelocity = F2(
	function (_p7, model) {
		var _p8 = _p7;
		var _p10 = _p8.y;
		var _p9 = _p8.x;
		...
		var newVel = function (n) {
			return (_elm_lang$core$Native_Utils.eq(_p9, 0) || _elm_lang$core$Native_Utils.eq(_p10, 0)) ? (scale * _elm_lang$core$Basics$toFloat(n)) : ((scale * _elm_lang$core$Basics$toFloat(n)) / _elm_lang$core$Basics$sqrt(2));
		};
		return _elm_lang$core$Native_Utils.update(
			model,
			{
...
var _user$project$Sprite$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {x: a, y: b, vx: c, vy: d, dir: e, orientation: f, frame: g};
	});
var _user$project$Sprite$Right = {ctor: 'Right'};
var _user$project$Sprite$Left = {ctor: 'Left'};
var _user$project$Sprite$Away = {ctor: 'Away'};
var _user$project$Sprite$Toward = {ctor: 'Toward'};
var _user$project$Sprite$init = A7(_user$project$Sprite$Model, _user$project$Map$halfWidth, _user$project$Map$halfHeight, 0, 0, _user$project$Sprite$Left, _user$project$Sprite$Toward, 0);
var _user$project$Sprite$setDirection = F2(
	function (_p11, model) {
		var _p12 = _p11;
		var _p14 = _p12.y;
		var _p13 = _p12.x;
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				orientation: (_elm_lang$core$Native_Utils.cmp(_p14, 0) < 0) ? _user$project$Sprite$Toward : ((_elm_lang$core$Native_Utils.cmp(_p14, 0) > 0) ? _user$project$Sprite$Away : model.orientation),
				dir: (_elm_lang$core$Native_Utils.cmp(_p13, 0) > 0) ? _user$project$Sprite$Right : ((_elm_lang$core$Native_Utils.cmp(_p13, 0) < 0) ? _user$project$Sprite$Left : model.dir)
			});
	});
var _user$project$Sprite$update = F2(
	function (msg, model) {
		var _p15 = msg;
		switch (_p15.ctor) {
			case 'Nothing':
			...
			case 'Direction':
				var _p16 = _p15._0;
				return A2(
					_user$project$Sprite$setDirection,
					_p16,
					A2(_user$project$Sprite$newVelocity, _p16, model));
			default:
				return _user$project$Sprite$updateFrame(
					A2(_user$project$Sprite$updatePosition, _p15._0, model));
		}
	});
var _user$project$Sprite$Nothing = {ctor: 'Nothing'};
var _user$project$Sprite$Direction = function (a) {
	return {ctor: 'Direction', _0: a};
};
var _user$project$Sprite$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};

var _user$project$Main$updateMap = F2(
	function (dt, model) {
		var _p0 = {ctor: '_Tuple4', _0: 0, _1: 0, _2: _user$project$Map$width, _3: _user$project$Map$height};
		var bottomWall = _p0._0;
		var leftWall = _p0._1;
		var rightWall = _p0._2;
		var topWall = _p0._3;
		var _p1 = {ctor: '_Tuple5', _0: model.sprite.x, _1: model.sprite.y, _2: model.sprite.vx, _3: model.sprite.vy, _4: model.map};
		var x = _p1._0;
		var y = _p1._1;
		var vx = _p1._2;
		var vy = _p1._3;
		...
		var _p2 = {
			ctor: '_Tuple4',
			_0: _elm_lang$core$Native_Utils.cmp(vy, 0) > 0,
			_1: _elm_lang$core$Native_Utils.cmp(vy, 0) < 0,
			_2: _elm_lang$core$Native_Utils.cmp(vx, 0) > 0,
			_3: _elm_lang$core$Native_Utils.cmp(vx, 0) < 0
		};
		var movingUp = _p2._0;
		var movingDown = _p2._1;
		var movingRight = _p2._2;
		var movingLeft = _p2._3;
		var action = (_elm_lang$core$Native_Utils.eq(x, leftWall) && movingLeft) ? _user$project$Map$HorizontalScroll(
			_elm_lang$core$Basics$round(dt * vx)) : ((_elm_lang$core$Native_Utils.eq(x + 32, rightWall) && movingRight) ? _user$project$Map$HorizontalScroll(
			_elm_lang$core$Basics$round(dt * vx)) : ((_elm_lang$core$Native_Utils.eq(y, topWall) && movingUp) ? _user$project$Map$VerticalScroll(
			_elm_lang$core$Basics$round(dt * vy)) : ((_elm_lang$core$Native_Utils.eq(y - 32, bottomWall) && movingDown) ? _user$project$Map$VerticalScroll(
			_elm_lang$core$Basics$round(dt * vy)) : _user$project$Map$HorizontalScroll(0))));
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				map: A2(_user$project$Map$update, action, map)
			});
	});
var _user$project$Main$updateSprite = F2(
	function (msg, model) {
		var sprite$ = A2(_user$project$Sprite$update, msg, model.sprite);
		return _elm_lang$core$Native_Utils.update(
			model,
			{sprite: sprite$});
	});
		...
		switch (_p3.ctor) {
			case 'Tick':
				...
				return {
					ctor: '_Tuple2',
					_0: A2(
						_user$project$Main$updateSprite,
						_user$project$Sprite$Tick(_p4),
						A2(_user$project$Main$updateMap, _p4, model)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyPress':
				var _p5 = A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p3._0, model.keyboard);
				var keyboard = _p5._0;
				var direction = _ohanhi$keyboard_extra$Keyboard_Extra$arrows(keyboard);
				return {
					ctor: '_Tuple2',
					_0: A2(
						_user$project$Main$updateSprite,
						_user$project$Sprite$Direction(direction),
						_elm_lang$core$Native_Utils.update(
							model,
							{keyboard: keyboard})),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {sprite: a, map: b, keyboard: c};
	});
var _user$project$Main$initialModel = function (keyboard) {
	return A3(_user$project$Main$Model, _user$project$Sprite$init, _user$project$Map$init, keyboard);
};
...
var _user$project$Main$view = function (model) {
	var bee = A2(
		...
		_user$project$Sprite$view(model.sprite));
	var inner = A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Map$view(model.map)),
				bee
			]));
	var middle = A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'display', _1: 'table-cell'},
...
var _user$project$Main$subs = _elm_lang$core$Platform_Sub$batch(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$KeyPress, _ohanhi$keyboard_extra$Keyboard_Extra$subscriptions),
			_elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Main$Tick)
		]));
var _user$project$Main$main = {
	main: function () {
		var _p8 = _ohanhi$keyboard_extra$Keyboard_Extra$init;
		var initialKeyboard = _p8._0;
		var keyboardCmd = _p8._1;
		return _elm_lang$html$Html_App$program(
			{
				init: {
					ctor: '_Tuple2',
					_0: _user$project$Main$initialModel(initialKeyboard),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$KeyPress, keyboardCmd)
				},
				update: _user$project$Main$update,
				subscriptions: _elm_lang$core$Basics$always(_user$project$Main$subs),
